    ...
    return(
        <Container style={{paddingTop: '50px'}} >
            ...
            <Col md={6} className="c-right">
                ...
                <span className='done'>{done && "Thanks for contacting me and be sure i have recieved your mail. I will get you soon . Also if you need me, you can conatct me on Linkedin."}</span>
                </form>
            </Col>
            </Row>
        </Container>
